...
Info
    Defines a GenReadmeBundle bundle for the CLI application.
'''
...
class GenReadmeBundle:
    '''
        GenReadmeBundle holding all components (adapters and services) of the CLI application.
    ...
    def merge(self, other: 'GenReadmeBundle') -> None:
        '''
            Merges non-None values from another bundle into this one.

            :param other: Another bundle to merge into this one.
            :type other: <GenReadmeBundle>
            :exceptions: None.
        '''
