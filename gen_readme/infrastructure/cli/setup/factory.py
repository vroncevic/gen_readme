...
from gen_readme.infrastructure.cli.setup.options import CLIBundleOptions
from gen_readme.infrastructure.cli.setup.opt_validator import CLIBundleOptionsValidator
from gen_readme.infrastructure.cli.setup.bundle import CLIBundle
from gen_readme.infrastructure.cli.setup.keys import CLIBundleKeys
...
from gen_readme.infrastructure.command.icommand_definition import ICommandDefinition
from gen_readme.infrastructure.command.icommand_executor import ICommandExecutor
...
class CLIBundleFactory:
    ...
    def create_bundle(cls, options: CLIBundleOptions) -> CLIBundle:
        ...
        service_definition: ICommandDefinition = GenReadmeCommandDefinition()
        service_executor: ICommandExecutor = GenReadmeCommandExecutor(definition=service_definition)
