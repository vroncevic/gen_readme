...
Info
    Defines GenReadmeCommandExecutor class.
'''
...
class GenReadmeCommandExecutor:
    '''
        Command executor strategy for generating readme project files.
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - Returns the GenReadmeCommandExecutor as string representation.
    '''
    ...
    def __str__(self) -> str:
        '''
            Returns the GenReadmeCommandExecutor as string representation.

            :return: The GenReadmeCommandExecutor as string representation.
        '''
        return to_str(self)
