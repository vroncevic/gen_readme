...
Info
    ...
    Generates README.md by templates and parameters.
'''
...
class GenReadmeModule(FileCheck, ProConfig, ProName):
    '''
        Defines class GenReadmeModule with attribute(s) and method(s).
        Generates README.md by templates and parameters.
        ...
        It defines:
            ...
            :attributes:
                ...
                | _writer - Writer API.
            :methods:
                | __init__ - Initials GenReadmeModule constructor.
                | get_reader - Gets template reader.
                | get_writer - Gets template writer.
                | gen_module - Generates README.md.
    '''

    _GEN_VERBOSE: str = 'GEN_README::PRO::GEN_SETUP'
    _PRO_STRUCTURE: str = '/../conf/project.yaml'

    def __init__(self, verbose: bool = False) -> None:
        '''
            Initials GenReadmeModule constructor.
