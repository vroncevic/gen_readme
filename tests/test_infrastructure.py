...
class TestInfrastructure(unittest.TestCase):
    '''
        ...
        It defines:
            ...
            :methods:
                ...
                | test_gen_readme_command_metadata - Tests GenReadmeCommand properties.
    ...
    def test_gen_readme_command_metadata(self) -> None:
        '''
            Tests GenReadmeCommand properties and parameter mapping execution.

            :exceptions: None.
        '''
        import datetime
        cmd: GenReadmeCommand = GenReadmeCommand()
        self.assertEqual(cmd.name, "generate-readme")
        self.assertEqual(cmd.help_text, "Generate README.md file")
        self.assertEqual(len(cmd.options), 9)
    ...
    def test_concrete_template_provider(self) -> None:
        ...
        py_template: str = provider.get_template_by_name("README_PY")
        self.assertTrue(len(py_template) > 0)

        js_template: str = provider.get_template_by_name("README_JS")
        self.assertTrue(len(js_template) > 0)
    ...
    def test_str_repr(self) -> None:
        ...
        cmd1: GenReadmeCommand = GenReadmeCommand()
